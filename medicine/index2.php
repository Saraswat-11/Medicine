      ...
      <div class="container">
        <div class="top_contact-container">
          <div class="tel_container">
            <a href="">
              <img src="images/telephone-symbol-button.png" alt=""> Call : +91 8650218395
            </a>
          </div>
        ...
        <nav class="navbar navbar-expand-lg custom_nav-container pt-3">
          ...
          <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <div class="d-flex  flex-column flex-lg-row align-items-center w-100 justify-content-between">
              ...
              <div class="cart_btn-contanier ml-2 ml-lg-4">
                <a href="cart.html">
                  <span>
                  CART
                  <span>
              ...
              <div class="row">
                ...
                <div class="col-md-8">
                  <div class="detail-box">
                    ...
                    <p>
                    When Life Gives You Lemons, Add a Little Medicine and a Lot of Laughter
                    </p>
                    <div>
          ...
          <div class="carousel-item active">
            <div class="client_container layout_padding2">
              <div class="client_detail">
                <p>
                  A Very Good Website To Buy Medicines
                </p>
              </div>
